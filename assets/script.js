    ...
    (async () => {
        ...
        const { value: formValues } = await Swal.fire({
          ...
          html:
            ...
            '<p>(1) Logo Link (Leave blank to keep it as it is):</p><input id="img_one">' +
            '<p>(2) Application Name (Leave blank to keep it as it is):</p><input id="name_two">' +
            '<p>(2) Logo Link (Leave blank to keep it as it is):</p><input id="img_two">' +
            '<p>(3) Application Name (Leave blank to keep it as it is):</p><input id="name_three">' +
            '<p>(3) Logo Link (Leave blank to keep it as it is):</p><input id="img_three">',
          focusConfirm: false,
          preConfirm: () => {
            if (document.getElementById('name_one').value != "") {
                ...
                createCookie("logo_one", ocument.getElementById('img_one').value, 7);
            }
            if (document.getElementById('name_two').value != "") {
                ...
                createCookie("logo_two", ocument.getElementById('img_two').value, 7);
            }
            if (document.getElementById('name_three').value != "") {
                ...
                createCookie("logo_three", ocument.getElementById('img_three').value, 7);
            }
...
function add_app(num) {
    (async () => {

        const { value: formValues } = await Swal.fire({
          title: 'Add multiple applications',
          html:
            '<p>Application Name (Leave blank to keep it as it is):</p><input id="name">' +
            '<p>Logo link (Leave blank to keep it as it is):</p><input id="img">',
          focusConfirm: false,
          preConfirm: () => {
            if (document.getElementById('name').value != "") {
                switch(num) {
                    case 1:
                        createCookie("app_one", document.getElementById('name').value, 7);
                        createCookie("exp_one", createExpiry(7), 7);
                        createCookie("add_one", addedTime(), 7);
                        break;
                    case 2:  
                        createCookie("app_two", document.getElementById('name').value, 7);
                        createCookie("exp_two", createExpiry(7), 7);
                        createCookie("add_two", addedTime(), 7);
                        break;
                    case 3:
                        createCookie("app_three", document.getElementById('name').value, 7);
                        createCookie("exp_three", createExpiry(7), 7);
                        createCookie("add_three", addedTime(), 7);
                        break;
                }
            ...
            if (document.getElementById('img').value != "") {
                switch(num) {
                    case 1:
                        createCookie("logo_one", document.getElementById('img').value, 7);
                        break;
                    case 2:     
                        createCookie("logo_two", document.getElementById('img').value, 7);
                        break;
                    case 3:      
                        createCookie("logo_three", document.getElementById('img').value, 7);
                        break;
                }
            }
...
function delete_app(num) {
    ...
    document.cookie = "logo_" + name + "=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
