            ...
            <div className="relative bg-white rounded-lg shadow-lg max-w-md w-full dark:bg-gray-800">
                ...
                <form className="p-4">
                    <div className="grid gap-4 mb-5 grid-cols-2">
                        ...
                        <div className="col-span-2">
                            <label htmlFor="price" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Logo</label>
                            <input type="number" name="price" id="price" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Leave empty for none" required />
                        </div>
                    </div>
